...
# Programs to install
pkgs="curl base-devel git dash neovim scrot xclip zsh-autosuggestions pulseaudio xorg xorg-xinit unclutter mpv sxiv zathura-pdf-mupdf ttf-joypixels gcr webkit2gtk gst-libav gst-plugins-good"
shell="zsh"
aurhelper="paru"
