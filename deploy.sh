...
shell="zsh"
aurhelper="paru"
aurpkgs="dashbinsh lf picom-git brave-bin zsh-fast-syntax-highlighting nerd-fonts-source-code-pro libxft-bgra simple-mtpfs mutt-wizard-git htop-vim-git gtk-theme-arc-gruvbox-git"
